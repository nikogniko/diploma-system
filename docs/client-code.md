...
- Фільтри: великі категорії мають власний пошук, плашки обраних значень і обмежений список зі скролом; компанії завантажуються з активних вакансій; локації фільтруються за областю або областю + містом; мови додаються парами `мова-рівень`.
